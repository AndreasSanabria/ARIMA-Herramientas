...
entrenamiento_inicio = '2023-01-01'
entrenamiento_final = '2023-05-20'
prueba_inicio = '2023-05-21'
prueba_final = '2023-06-04'
...
pyplot.suptitle('Predicción de la tasa de cambio a 15 días')
pyplot.title('Entrenando el modelo en el 2023')
